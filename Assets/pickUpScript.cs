...
public class PickUpScript : MonoBehaviour
{
    ...
    void RotateObject()
    {
        if (Input.GetKey(KeyCode.R))//hold R key to rotate, change this to whatever key you want
        {
            ...
            cameraControllerFPS.sensitivity = 0;
            ...
            // horizontal rotation relative to player’s up
            heldObj.transform.Rotate(transform.up, -XaxisRotation, Space.World);

            // vertical rotation relative to player’s right
        ...
        else
        {
            ...
            cameraControllerFPS.sensitivity = originalSensitivity;
